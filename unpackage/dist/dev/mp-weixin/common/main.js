...
/* 0 */
/*!************************************************************!*\
  !*** /Users/chengyongming/WeChatProjects/mini-car/main.js ***!
  \************************************************************/
...
var $api = _interopRequireWildcard(__webpack_require__(/*! @/common/api/api.js */ 14));
...
var _zh = _interopRequireDefault(__webpack_require__(/*! @/common/locales/zh.js */ 74));
var _en = _interopRequireDefault(__webpack_require__(/*! @/common/locales/en.js */ 75));


var _vueI18nMin = _interopRequireDefault(__webpack_require__(/*! @/common/vue-i18n.min.js */ 76));
...
var _httpInterceptor = _interopRequireDefault(__webpack_require__(/*! @/common/http.interceptor.js */ 77));function _getRequireWildcardCache() {if (typeof WeakMap !== "function") return null;var cache = new WeakMap();_getRequireWildcardCache = function _getRequireWildcardCache() {return cache;};return cache;}function _interopRequireWildcard(obj) {if (obj && obj.__esModule) {return obj;}if (obj === null || typeof obj !== "object" && typeof obj !== "function") {return { default: obj };}var cache = _getRequireWildcardCache();if (cache && cache.has(obj)) {return cache.get(obj);}var newObj = {};var hasPropertyDescriptor = Object.defineProperty && Object.getOwnPropertyDescriptor;for (var key in obj) {if (Object.prototype.hasOwnProperty.call(obj, key)) {var desc = hasPropertyDescriptor ? Object.getOwnPropertyDescriptor(obj, key) : null;if (desc && (desc.get || desc.set)) {Object.defineProperty(newObj, key, desc);} else {newObj[key] = obj[key];}}}newObj.default = obj;if (cache) {cache.set(obj, newObj);}return newObj;}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}function ownKeys(object, enumerableOnly) {var keys = Object.keys(object);if (Object.getOwnPropertySymbols) {var symbols = Object.getOwnPropertySymbols(object);if (enumerableOnly) symbols = symbols.filter(function (sym) {return Object.getOwnPropertyDescriptor(object, sym).enumerable;});keys.push.apply(keys, symbols);}return keys;}function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};if (i % 2) {ownKeys(Object(source), true).forEach(function (key) {_defineProperty(target, key, source[key]);});} else if (Object.getOwnPropertyDescriptors) {Object.defineProperties(target, Object.getOwnPropertyDescriptors(source));} else {ownKeys(Object(source)).forEach(function (key) {Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key));});}}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}_vue.default.config.productionTip = false;_vue.default.prototype.$httpapi = _httpApi.default;_App.default.mpType = 'app';_vue.default.prototype.$api = $api; // 此处为演示Vue.prototype使用，非uView的功能部分
_vue.default.prototype.vuePrototype = '枣红'; // 引入全局uView
_vue.default.use(_uviewUi.default); // 此处为演示vuex使用，非uView的功能部分
// 引入uView提供的对vuex的简写法文件
var vuexStore = __webpack_require__(/*! @/store/$u.mixin.js */ 78);_vue.default.mixin(vuexStore); // 引入uView对小程序分享的mixin封装
var mpShare = __webpack_require__(/*! uview-ui/libs/mixin/mpShare.js */ 79);_vue.default.mixin(mpShare); // i18n部分的配置
// 引入语言包，注意路径
// VueI18n
...
_vue.default.prototype._i18n = i18n;var app = new _vue.default(_objectSpread({ i18n: i18n, store: _store.default }, _App.default));_vue.default.prototype.relogin = function () {if (uni.getStorageSync("mini_car_token")) {var setTimeputId = setTimeout(function () {console.log(new Date() + ' refresh_mini_car_token');uni.getSetting({ success: function success(res) {console.log("授权：", res);if (!res.authSetting['scope.userInfo']) {//这里调用授权
            console.log("当前未授权"); //触发定时检测程序，如果授权了，那就跳转，没有的话就继续检测
            console.log("未登录");} else {//用户已经授权过了
            console.log("当前已授权了");var that = this;uni.login({ provider: 'weixin', success: function success(loginRes) {uni.getUserInfo({ provider: 'weixin', success: function success(infoRes) {var data = { code: loginRes.code, encryptedData: infoRes.encryptedData, iv: infoRes.iv, userInfo: infoRes.userInfo, rawData: infoRes.rawData, signature: infoRes.signature, channel: "wechat", inviter: uni.getStorageSync("inviter_user_id") };uni.request({ url: 'https://chengym.com.cn/library/butt-auth', method: 'POST', header: { "content-type": "application/json" }, data: data, success: function () {var _success = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee(ress) {return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (ress && ress.statusCode === 200) {uni.setStorageSync("mini_car_token", ress.data.token);uni.setStorageSync("mini_car_userid", ress.data.userid);} else {}case 1:case "end":return _context.stop();}}}, _callee);}));function success(_x) {return _success.apply(this, arguments);}return success;}(), fail: function fail(err) {console.log(err);} });} });} });}} });}); // getApp().globalData.setTimeoutForRefreshToken = setTimeputId
  } else {console.log('未登录');}};_vue.default.prototype.setRelogin = function () {var _this = this;console.log('start refresh_token');setInterval(function () {var that = _this;that.relogin(); // }, 1000);
  }, 300000);}; // http拦截器，将此部分放在new Vue()和app.$mount()之间，才能App.vue中正常使用
...
/* 8 */
/*!************************************************************!*\
  !*** /Users/chengyongming/WeChatProjects/mini-car/App.vue ***!
  \************************************************************/
/*! no static exports found */
...
/* 9 */
/*!*************************************************************************************!*\
  !*** /Users/chengyongming/WeChatProjects/mini-car/App.vue?vue&type=script&lang=js& ***!
  \*************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* 11 */
/*!**********************************************************************************************!*\
  !*** /Users/chengyongming/WeChatProjects/mini-car/App.vue?vue&type=style&index=0&lang=scss& ***!
  \**********************************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
